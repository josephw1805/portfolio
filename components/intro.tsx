...
export default function Intro() {
  ...
  const { setActiveSection, setTimeOfLastClick } = useActiveSectionCotext();
  return (
    <section
      id="home"
      ref={ref}
    ...
    >
      ...
      >
        <span className="font-bold">Hello! I&apos;m Joseph Weng,</span> a{" "}
      ...
      >
        ...
        <a
          href="/Joseph_Weng_resume.pdf"
          download
          className="group cursor-pointer borderBlack bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition dark:bg-white/10"
        >
          Download CV{" "}
          <HiDownload className="opacity-60 group-hover:translate-y-1 transition" />
        </a>
        <a
          href="https://www.linkedin.com/in/joseph-weng-ab754256"
          target="_blank"
        ...
        <a
          href="https://github.com/josephW1805"
          target="_blank"
